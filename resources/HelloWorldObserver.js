...
var _srcSyncherSyncher = require('../../src/syncher/Syncher');

var _srcSyncherSyncher2 = _interopRequireDefault(_srcSyncherSyncher);

var _srcUtilsUtils = require('../../src/utils/utils');

var _srcUtilsEventEmitter = require('../../src/utils/EventEmitter');

var _srcUtilsEventEmitter2 = _interopRequireDefault(_srcUtilsEventEmitter);
...
var HelloWorldObserver = (function (_EventEmitter) {
  ...
  */
  ...
  function HelloWorldObserver(hypertyURL, bus, configuration) {
    ...
    _get(Object.getPrototypeOf(HelloWorldObserver.prototype), 'constructor', this).call(this);

    var _this = this;
    _this._domain = (0, _srcUtilsUtils.divideURL)(hypertyURL).domain;

    _this._objectDescURL = 'hyperty-catalogue://' + _this._domain + '/.well-known/dataschemas/HelloWorldDataSchema';

    var domain = (0, _srcUtilsUtils.divideURL)(hypertyURL).domain;

    var syncher = new _srcSyncherSyncher2['default'](hypertyURL, bus, configuration);
...
})(_srcUtilsEventEmitter2['default']);
...
},{"../../src/syncher/Syncher":8,"../../src/utils/EventEmitter":9,"../../src/utils/utils":10}],2:[function(require,module,exports){
/**
...
},{"../utils/utils.js":10,"./DataObjectChild":3,"./SyncObject":7}],3:[function(require,module,exports){
/**
* Copyright 2016 PT Inovação e Sistemas SA
* Copyright 2016 INESC-ID
* Copyright 2016 QUOBIS NETWORKS SL
...
},{"./DataObject":2}],5:[function(require,module,exports){
/**
* Copyright 2016 PT Inovação e Sistemas SA
* Copyright 2016 INESC-ID
* Copyright 2016 QUOBIS NETWORKS SL
...
},{"../utils/utils.js":10,"./DataObject":2}],6:[function(require,module,exports){
/**
* Copyright 2016 PT Inovação e Sistemas SA
* Copyright 2016 INESC-ID
* Copyright 2016 QUOBIS NETWORKS SL
...
},{"../utils/utils.js":10}],8:[function(require,module,exports){
/**
* Copyright 2016 PT Inovação e Sistemas SA
* Copyright 2016 INESC-ID
* Copyright 2016 QUOBIS NETWORKS SL
