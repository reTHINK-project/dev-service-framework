...
| **description**      |          string          |      yes      | A description of the Catalogue Object                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| **Attribute Name**      | **Attribute Type** | **Mandatory** | **Description**                                                                                                                                   |
|-------------------------|:------------------:|:-------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------|
| **encoding**            |       string       |      no       | Encoding used in the SourceCode in case we have non-printable characters                                                                          |
...
| **Attribute Name** |                    **Attribute Type**                       | **Mandatory** | **Description**                                                                                                                                                                                                                                                                      |
|--------------------|:-----------------------------------------------------------:|:-------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **hypertyType**    |                        HypertyType                          |      yes      | A tag that identifies what type of hyperty is described in the object.                                                                                                                                                                                                               |
...
| **configuration**  |                 ProtostubConfiguration                  |      yes      | Data required to configure the ProtocolStub                                                                                                                                                                                                                                               |
| **constraints**    |               RuntimeProtocolCapabilities               |      yes      | [RuntimeProtocolCapabilities](#hyperty-runtime-descriptor) describes capabilities required from the Hyperty Runtime in order to be able to execute the ProtocolStub                                                                                                                       |
