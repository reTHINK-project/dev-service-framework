...
-	Hyperty Policy Enforcer Descriptors
...
| **configuration**  |                                                       ConfigurationDataList                                                       |      no       | A list of Data elements required to configure the Hyperty                                                                                                                                                                                                                            |
| **constraints**    |                                                       RuntimeConstraintList                                                       |      no       | A list of [RuntimeHypertyCapabilityType](#hyperty-runtime-descriptor) describing capabilities required from the Hyperty Runtime in order to be able to execute the Hyperty                                                                                                           |
...
| **configuration**  |                  ConfigurationDataList                  |      no       | A list of Data elements required to configure the ProtocolStub                                                                                                                                                                                                                            |
| **constraints**    |                  RuntimeConstraintList                  |      no       | A list of [RuntimeHypertyCapabilityType](#hyperty-runtime-descriptor) describing capabilities required from the Hyperty Runtime in order to be able to execute the ProtocolStub                                                                                                           |

### Hyperty Policy Enforcer Descriptor

![Hyperty Policy Enforcer Data Object Model](../Policy-Enforcer-Descriptor-Data-Object-Model.png)

This Descriptor Data Object is used to model policy enforcement on Hyperties.

The Policy Enforcer descriptor contains the policies to be enforce rule Hyperty execution (HypertyPolicy) and the data needed to configure the its deployment in the runtime.

### Hyperty Runtime Descriptor

![Hyperty Runtime Descriptor Model](../Hyperty-Runtime-Descriptor-Data-Object-Model.png)

The Hyperty Runtime Descriptor is used to model the Runtime that can be used to execute Hyperties in a certain device or network server. Hyperty Runtimes are described in terms of supported capabilities to execute Hyperties (RuntimeHypertyCapability) and Protocol Stubs (RuntimeProtocolCapability) and its type including browser, standalone, server and (IoT/M2M) gateway.
