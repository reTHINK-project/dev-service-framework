...
class CatalogueDataObjectFactory extends rethinkObject {
    ...
    createCatalogueDataObject(guid, type, objectName, description, language, sourcePackageURL) {
        if (
            ...
            || typeof type === "undefined" || !(type instanceof CatalogueObjectType)
            || typeof objectName === "undefined"
            || typeof description === "undefined"
            || typeof language === "undefined" || !(language instanceof DataObjectSourceLanguage)
    ...
    createHypertyDescriptorObject(guid, catalogueType, objectName, description, language, sourcePackageURL, hypertyType,
        ...
        if (
            ...
            || typeof language === "undefined" || !(language instanceof DataObjectSourceLanguage)
            || typeof sourcePackageURL === "undefined"
            || typeof hypertyType === "undefined" || !(hypertyType instanceof HypertyType)
    ...
    createProtoStubDescriptorObject(guid, type, objectName, description, language, sourcePackageURL, messageSchemas,
        ...
        if (
            ...
            || typeof configurationList === "undefined" || !(configurationList instanceof Array)
            || typeof constraintList === "undefined" || !(constraintList instanceof Array)
        )
            throw new Error("Invalid parameters!");
    ...
    createHypertRuntimeDescriptorObject(guid, catalogueType, objectName, description, language, sourcePackageURL,
        ...
        if (
            ...
            || typeof language === "undefined" || !(language instanceof DataObjectSourceLanguage)
            || typeof sourcePackageURL === "undefined"
            || typeof runtimeType === "undefined" || !(runtimeType instanceof RuntimeType)
            || typeof hypertyCapabilities === "undefined" || !(hypertyCapabilities instanceof Array)
            || !(hypertyCapabilities instanceof RuntimeHypertyCapabilityType)
            || typeof protocolCapabilities === "undefined" || !(protocolCapabilities instanceof Array)
            || !(protocolCapabilities instanceof RuntimeProtocolCapabilityType)
        )
            throw new Error("Invalid parameters!");
    ...
    createPolicyEnforcerDescriptorObject(guid, type, objectName, description, language, sourcePackageURL, configuration,
        ...
        if (
            ...
            || typeof language === "undefined" || !(language instanceof DataObjectSourceLanguage)
            || typeof sourcePackageURL === "undefined"
            || typeof configuration === "undefined" || !(configuration instanceof Array)
            || typeof policies === "undefined" || !(policies instanceof Array)
        )
            throw new Error("Invalid parameters!");
