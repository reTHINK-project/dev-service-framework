  ...
  */
  ...
  (0, _createClass3.default)(Discovery, [{
    ...
    */
    ...
    /**
    * function to request global registry about the user active domain's associated with the GUID
    * @param  {guid}              guid
    * @param  {domain}            domain (Optional)
    * @return {Promise}          Promise
    */
    ...
    key: 'discoveryUserAtiveDomains',
    value: function discoveryUserAtiveDomains(guid, domain) {
      var _this = this;
      var activeDomain = void 0;
      ...
      //Query the discovery service to translate an userID (e.g. email) to GUID
      //GUID should be obtained from the discovery services

      // message to query global registry, asking for user active domain's
      //type: 'READ', from: _this.discoveryURL, to: 'global://registry/' + activeDomain + '/', body: { guid: guid}

      var message = {
        type: 'READ', from: _this.discoveryURL, to: 'global://registry/', body: { guid: guid }
      };

      console.log('Message discoveryUserAtiveDomains: ', message, activeDomain, guid);
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        _this.messageBus.postMessage(message, function (reply) {
          ...
          if (!value) {
            return reject('GUID not found in global registry');
          }
