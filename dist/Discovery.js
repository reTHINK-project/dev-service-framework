      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        if (!_this._subscriptionSet) {
          _this._subscribe().then(function () {
            _this._subscribers.live.push(callback);
            resolve();
          }).catch(function (err) {
            return reject(err);
          });
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        if (!_this2._subscriptionSet) {
          _this2._subscribe().then(function () {
            _this2._subscribers.disconnected.push(callback);
            resolve();
          }).catch(function (err) {
            return reject(err);
          });
