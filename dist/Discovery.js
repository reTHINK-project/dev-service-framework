      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        $.ajax({
          ...
          success: function success(json) {
            ...
            var guid = response.results.filter(function (x) {
