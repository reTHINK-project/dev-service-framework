  ...
  (0, _createClass3.default)(DataObjectObserver, [{
    ...
    value: function _sync() {
      ...
      _this._syncher.read(_this._metadata.url).then(function (value) {
        ...
        _this._syncObj = (0, _utils.deepClone)(value.data);
