  ...
  */
  ...
  function DataObjectObserver(input) {
    ...
    if (input.childrenObjects) {
      (0, _keys2.default)(input.childrenObjects).forEach(function (childrenResource) {
        var children = input.childrenObjects[childrenResource];
