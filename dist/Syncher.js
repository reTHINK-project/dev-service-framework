  ...
  (0, _createClass3.default)(HypertyResource, [{
    ...
    value: function read() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        if (_this.content) {
          ...
          var contentURL = _this._getBestContentURL(_this._metadata.contentURL);

          var msg = {
            from: _this._owner,
            to: _this._runtime + '/storage',
            type: 'read',
            body: { resource: contentURL, p2p: true }
          };
    ...
    value: function _getBestContentURL(contentURLList) {
      ...
      contentURLList.forEach(function (url) {
        if (url.includes(_this._localStorageURL)) return url;
      });
