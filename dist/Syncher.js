  ...
  */
  ...
  function DataObjectObserver(input) {
    ...
    (0, _keys2.default)(input.initialData.childrens).forEach(function (childrenResource) {
      var children = input.initialData.childrens[childrenResource];
  ...
  (0, _createClass3.default)(Syncher, [{
    ...
    */
    value: function create(schema, observers, initialData) {
      ...
      var description = arguments[7];
      var tags = arguments[8];
      var resources = arguments[9];
      var observerStorage = arguments[10];
      var publicObservation = arguments[11];
      ...
      if (resources) {
        createInput.resources = resources;
      }
      if (observerStorage) {
        createInput.observerStorage = observerStorage;
      }
      if (publicObservation) {
        createInput.publicObservation = publicObservation;
      }

      (0, _assign2.default)(createInput, { resume: false });
    ...
    */
    ...
    value: function _create(input) {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        var initialData = input.initialData || {};
